...
class AppTest < Minitest::Test
  def setup
    ...
    @tree.add_route('account/workspaces/:workspace_id/members/:id').freeze
    @tree.add_route('account/workspaces/:workspace_id/projects/:id').freeze
    @tree.add_route('account/task/:id').freeze
  end
